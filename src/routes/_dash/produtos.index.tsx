...
import { Copy, MoreHorizontal, Package, Pencil, Plus, Power, Search, Trash2 } from "lucide-react";
...
function Produtos() {
  ...
  return (
    <>
      <PageHeader
        title="Produtos"
        subtitle="Gerencie seus produtos e ofertas em um só catálogo."
        actions={createButton("Criar produto")}
      />
